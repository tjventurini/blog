<template>
    <div class="header mx-auto py-4">
        <div class="grid grid-cols-12">
            <div
                class="col-span-3 sm:col-span-2 md:col-span-2 lg:col-span-1 align-middle"
            >
                <a href="/">
                    <Logo />
                </a>
            </div>
            <div class="col-span-7 sm:col-span-8 lg:col-span-10">
                <a href="/">
                    <h1 class="hidden sm:block">
                        <span
                            class="align-middle heading-10 font-bold text-4xl"
                            >{{ $site.title }}</span
                        >
                    </h1>
                </a>
            ...
            <div
                class="col-span-2 sm:col-span-2 md:col-span-2 lg:col-span-1 text-center"
            >
                <button
        ...
        >
            <div
                class="navigation-body relative top-0 mx-auto w-full max-w-screen-lg"
            >
                <button
                    @click="toggleNavigationOverlay"
                ...
                <div class="navigation-content mt-20">
                    <div class="navigation text-center mt-8 text-xl">
                        <a href="/"
                            ><i class="fa fa-home moving-gradient-text"></i
                            >&nbsp;Home</a
                        >
                        |
                        <a href="/articles/"
                            ><i
                                class="fa fa-feather-alt moving-gradient-text"
                            ></i
                            >&nbsp;Articles</a
                        >
                        |
                        <a href="/tags/"
                            ><i class="fa fa-tags moving-gradient-text"></i
                            >&nbsp;Tags</a
                        >
                    </div>
